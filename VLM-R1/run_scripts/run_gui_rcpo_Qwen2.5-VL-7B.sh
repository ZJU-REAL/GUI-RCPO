...
model_path="Qwen/Qwen2.5-VL-7B-Instruct" # change to your own model path
is_reward_customized_from_vlm_module=False
echo "data_paths: $data_paths"
echo "image_folders: $image_folders"

export EXP_NAME="TTRL-GUI-Grounding-screenspot_v2-Qwen2.5-VL-7B-bs64" # TODO: change this to your own experiment name
TASK_TYPE="gui"
...
# export CUDA_VISIBLE_DEVICES=0,1,2,7 # TODO: change this to your own GPUs
