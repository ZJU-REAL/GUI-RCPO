...
model_path="/home/shenyl/hf/model/OS-Copilot/OS-Atlas-Base-7B" # change to your own model path
is_reward_customized_from_vlm_module=False
echo "data_paths: $data_paths"
echo "image_folders: $image_folders"

export EXP_NAME="TTRL-GUI-Grounding-screenspot_v2-OS-Atlas-7B-bs64" # TODO: change this to your own experiment name
TASK_TYPE="gui"
